...
Uma heap é um tipo especial de árvore binária completa ou quase completa, que segue a regra de que o valor dos seus nós devem ser maiores/iguais ou menores/iguais ao valor de seu nó pai dependo da sua implementação ser máxima ou mínima.
